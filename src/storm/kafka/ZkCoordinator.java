...
public class ZkCoordinator implements PartitionCoordinator {
    ...
    ZkState _state;
    Map<String,Object> _stormConf;
    IMetricsContext _metricsContext;
    
    public ZkCoordinator(DynamicPartitionConnections connections, Map<String,Object> stormConf, SpoutConfig spoutConfig, ZkState state, int taskIndex, int totalTasks, String topologyInstanceId) {
    ...
    void refresh() {
        try {
            ...
            Map<String, List<Long>> brokerInfo = _reader.getBrokerInfo();
            
            Set<GlobalPartitionId> mine = new HashSet<GlobalPartitionId>();
            for(String host: brokerInfo.keySet()) {
                List<Long> info = brokerInfo.get(host);
